...
def seed_database():
    ...
    with app.app_context():
        ...
        # 1. 建立測試使用者 (符合逢甲信箱)
        print("正在建立測試使用者...")
        u1 = User.create(username="小明", email="d1234567@mail.fcu.edu.tw", password="password")
        u2 = User.create(username="小華", email="d7654321@mail.fcu.edu.tw", password="password")
        u3 = User.create(username="美食家", email="t0000001@fcu.edu.tw", password="password")
