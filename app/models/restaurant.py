...
class Restaurant(db.Model):
    ...
    @classmethod
    def create(cls, name, address, phone=None, opening_hours=None, landmark=None, tag_names=None):
        """建立餐廳資料，可選傳入標籤名稱列表"""
        restaurant = cls(
            name=name,
            address=address,
    ...
    def update(self, name=None, address=None, phone=None, opening_hours=None, landmark=None, tag_names=None):
        """更新餐廳資料與標籤關係"""
        if name:
            self.name = name
        if address:
